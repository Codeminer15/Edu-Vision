...
import ConocerPage from "./conocer/page";
...
const App = () => {
  ...
  if (page === "conocer") {
    return <ConocerPage onBack={() => setPage("home")} />;
  }
  const Logo = ({ size = "normal" }: { size?: string }) => {
    ...
    return (
      <div
        ...
        } bg-blue-50 rounded-xl shadow-inner border border-blue-100`}
      >
        <BookOpen size={isSmall ? 22 : 32} className="absolute text-blue-700" />
        <Lightbulb
          size={isSmall ? 10 : 16}
          className={`absolute text-emerald-500 ${isSmall ? "mb-1" : "mb-2"}`}
        />
        <Calendar
          size={isSmall ? 8 : 12}
          className="absolute -top-1 -right-1 text-blue-500 bg-white rounded-sm"
        />
        <CheckSquare
          size={isSmall ? 8 : 12}
          className="absolute top-1 -left-2 text-emerald-600 bg-white rounded-sm"
        />
        <Video
          size={isSmall ? 8 : 12}
          className="absolute -bottom-1 right-0 text-blue-600 bg-white rounded-sm"
        />
      </div>
    );
  };
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-extrabold text-2xl text-blue-900 tracking-tight leading-none">
                  Edu Vision
                </span>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-blue-50 via-white to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <p className="text-xl text-slate-600 mb-10 max-w-3xl leading-relaxed">
            Una aplicación innovadora diseñada para facilitar la gestión
            docente, mejorar la planeación educativa y apoyar el aprendizaje de
            los estudiantes mediante herramientas digitales.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            {/*Botón para llegar a la pagina de conocer */}
            <button
              onClick={() => setPage("conocer")}
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-xl flex items-center justify-center gap-2"
            >
              Conocer Edu Vision
              <TrendingUp size={20} />
            </button>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-extrabold text-blue-950 mb-6 leading-tight">
                ¿Qué es Edu Vision App?
              </h2>
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Edu Vision App es una plataforma digital diseñada para apoyar a
                los docentes en su labor diaria.
              </p>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Permite realizar diagnósticos de los estudiantes, crear
                planeaciones didácticas, gestionar actividades y utilizar
                recursos multimedia como series y películas para mejorar el
                aprendizaje.
              </p>
              <div className="flex items-center gap-4 bg-emerald-50 p-4 rounded-2xl border border-emerald-100">
                ...
                <div>
                  ...
                  <p className="text-emerald-700">
                    Aplicación móvil educativa dirigida exclusivamente a{" "}
                    <strong>docentes de nivel preescolar</strong>.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-white border border-slate-100 rounded-3xl shadow-2xl p-8">
                ...
                <ul className="space-y-5">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-4 bg-slate-50 p-4 rounded-xl hover:bg-blue-50 transition-colors"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <Users size={28} />,
                title: "Diagnóstico de estudiantes",
                desc: "Evalúa y conoce las necesidades individuales de cada alumno.",
                color: "blue",
              },
              {
                icon: <Calendar size={28} />,
                title: "Planeación automática de clases",
                desc: "Genera estructuras didácticas ahorrando tiempo valioso.",
                color: "emerald",
              },
              {
                icon: <CheckSquare size={28} />,
                title: "Organización de actividades",
                desc: "Mantén el control de todas las tareas y dinámicas del aula.",
                color: "indigo",
              },
              {
                icon: <Video size={28} />,
                title: "Recursos multimedia educativos",
                desc: "Integra series y películas adaptadas para educación preescolar.",
                color: "purple",
              },
              {
                icon: <BarChart3 size={28} />,
                title: "Seguimiento del progreso",
                desc: "Monitorea el avance de aprendizaje de forma clara y visual.",
                color: "rose",
              },
            ].map((feature, idx) => (
              <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-200 max-w-2xl mx-auto text-lg">
              Visión integral del proyecto, posicionamiento y ventajas
              competitivas.
            </p>
          </div>
                    ...
                    <ul className="space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          text: "Uso de tecnología",
                        },
                        {
                          icon: <Lightbulb size={20} />,
                          text: "Aprendizaje significativo",
                        },
                      ].map((item, i) => (
                        <li
                          key={i}
            ...
            {activeTab === "competition" && (
              <div>
                ...
                <p className="text-slate-600 text-center text-lg">
                  Contenido de competencia próximamente.
                </p>
              </div>
            )}
          </div>
